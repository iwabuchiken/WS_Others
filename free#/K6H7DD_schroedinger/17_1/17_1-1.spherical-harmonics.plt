...
Y(u,v)=sqrt(param / ( 4.0 * pi))* 0.5 * (3.0 * cos(u)** 2 - 1) # 球面調和関数
#Y(u,v)=sqrt(5.0/( 20.0 * pi))* 0.5 * (3.0 * cos(u)** 2 - 1) # 球面調和関数
#Y(u,v)=sqrt(5.0/( param * pi))* 0.5 * (3.0 * cos(u)** 2 - 1) # 球面調和関数
#Y(u,v)=sqrt(5.0/(4.0*pi))* param * (3.0 * cos(u)** 2 - 1) # 球面調和関数
#Y(u,v)=sqrt(5.0/(4.0*pi))*0.5* (3.0 * cos(u)** param - 1) # 球面調和関数
