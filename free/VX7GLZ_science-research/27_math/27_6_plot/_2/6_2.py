...
# def _test_7_3__Generate_PNGFiles(dpath_Full, session_Label):
...
#                 , np.sin(pi / 4 * val_StartingPoint_Multiplier))
        ...
        dpath_Full_Each = _test_7_3__Generate_PNGFiles \
                    (dpath_Full
                     , session_Label
                     , set_Pow
                     , id_Dir
...
def _test_7_2__Generate_PNGFiles \
(dpath_Full, session_Label, 
set_Pow, id_Dir, 
start_Coord=(np.cos(pi / 4 * 0), np.sin(pi / 4 * 0)),
_numOf_TickDivision = 24
):
# def _test_7_2__Generate_PNGFiles(dpath_Full, session_Label):
...
#                     , val_Scalar_a01
        ...
        #ref https://stackoverflow.com/questions/17682216/scatter-plot-and-color-mapping-in-python answered Jul 16 '13 at 16:45
        ax.scatter(xs_, ys_, s = 20, c = range(0, len(xs_)), cmap='viridis')
#         ax.scatter(xs_, ys_, s = 30, c = xs_, cmap='viridis')
...
#         ax.scatter(xs_, ys_, s = 30, c = xs_)
#         ax.scatter(xs_, ys_, s = 30, c = xs_)
#         ax.scatter(xs_, ys_, s = 30, c = cnt)    #=> TypeError: object of type 'int' has no len()
#         ax.scatter(xs_, ys_, s = 30, c = col_Series)    #=> AttributeError: 'str' object has no attribute 'shape'
#         ax.scatter(xs_, ys_, s = 30, color = col_Series)
#         ax.scatter(xs_, ys_, s = 30, color = 'forestgreen')
#         ax.scatter(xs_, ys_, s = 30, color = 'forestgreen')
#         ax.scatter(xs_, ys_, s = 30, color = 'lawngreen')
         
        ax.scatter([x2], [y2], s = 30, color = 'gray')
#         ax.scatter([x2], [y2], s = 30, color = 'darkviolet')
#         ax.scatter([x2], [y2], s = 30, color = 'darkviolet')
         
#         ax.scatter(xs_, ys_, s = 30, color = 'b')
...
#                 , np.sin(pi / 4 * val_StartingPoint_Multiplier))
        ...
        dpath_Full_Each = _test_7_2__Generate_PNGFiles \
                    (dpath_Full
                     , session_Label
                     , set_Pow
                     , id_Dir
...
def _test_7__Generate_PNGFiles(dpath_Full, session_Label, set_Pow, id_Dir):
# def _test_7__Generate_PNGFiles(dpath_Full, session_Label):
...
def test_7():
    ...
    dname_Images       = "images"
    dname_Images_PNG   = "images_%s" % tlabel
    session_Label      = "6_4-1.test-7"
    
    fps_FFMpeg          = 4 # 4 frames per second
#     fps_FFMpeg          = 2
...
#     print()
#     
# #     fpath_Glob = os.path.dirname(fpath_Glob) + "\\" \
# #                 + os.path.basename(dpath_Full_Each) + "\\" \
# #                 + os.path.basename(fpath_Glob)
#     
#     
#     return
...
#                 , (1, 1, 1, 2)
    ...
    for set_Pow in lo_Pow :
        '''###################
            gen : png files        
        ###################'''
#         result = _test_7__Generate_PNGFiles \
        dpath_Full_Each = _test_7__Generate_PNGFiles \
                    (dpath_Full, session_Label, set_Pow, id_Dir)
...
#         print()
#         print("[%s:%d] fpath_Out_FFMpeg(modified) => %s" % \
#                         (os.path.basename(libs.thisfile()), libs.linenum()
#                         , fpath_Out_FFMpeg
#                         ), file=sys.stderr)
...
# 
#         print()
#         print("[%s:%d] fpath_In_FFMpeg(modified) => %s" % \
#                         (os.path.basename(libs.thisfile()), libs.linenum()
#                         , fpath_In_FFMpeg
#                         ), file=sys.stderr)
...
# 
#         print()
#         print("[%s:%d] fpath_Glob(modified) => %s" % \
#                         (os.path.basename(libs.thisfile()), libs.linenum()
#                         , fpath_Glob
#                         ), file=sys.stderr)
...
def _test_6__Generate_PNGFiles(dpath_Full, session_Label, set_Pow, id_Dir):
# def _test_6__Generate_PNGFiles(dpath_Full, session_Label):
...
#                 , (1, 1, 1, 2)
    ...
    for set_Pow in lo_Pow :
        '''###################
            gen : png files        
        ###################'''
#         result = _test_6__Generate_PNGFiles \
        dpath_Full_Each = _test_6__Generate_PNGFiles \
                    (dpath_Full, session_Label, set_Pow, id_Dir)
